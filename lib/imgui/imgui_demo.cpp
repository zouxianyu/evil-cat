...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (ImGui::CollapsingHeader("Help"))
    {
        ...
        ImGui::BulletText("The \"Tools\" menu above gives access to: About showEspBox3D, Style Editor,\n"
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Querying Window Status (Focused/Hovered etc.)"))
    {
        ...
        // Calling IsItemHovered() after loop returns the hovered status of the title bar.
        ...
        if (test_window)
        {
            ...
            ImGui::Text(
                "IsItemHovered() after loop = %d (== is title bar hovered)\n"
                "IsItemActive() after loop = %d (== is window being clicked/moved)\n",
...
static void ShowDemoWindowLayout()
{
    ...
    {
        HelpMarker("Use child windows to loop into a self-contained independent scrolling/clipping regions within a host window.");
    ...
    if (ImGui::TreeNode("Basic Horizontal Layout"))
    {
        ...
        {
            ImGui::PushID(n);
            ImGui::Button("showEspBox3D", button_sz);
...
struct ExampleAppConsole
{
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        // If you only want raw text you can use ImGui::TextUnformatted(log.loop(), log.end());
